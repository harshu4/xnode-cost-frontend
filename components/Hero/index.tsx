...
const Hero = () => {
  return (
    <>
      ...
      >
        <div className="">
          <div className="text-[24px] font-medium -tracking-[2%] md:text-[33px] lg:!leading-[58px] xl:text-[48px]">
            Openmesh Expert Community
          </div>
          <div className="mt-[21px] text-[10px] font-normal -tracking-[2%] text-[#959595] md:text-[14px] lg:!leading-[150%] xl:max-w-[1250px] xl:text-[20px]">
          ...
          <div className="mt-[21px] cursor-pointer text-[10px] font-bold -tracking-[2%] text-[#0354EC] hover:text-[#2d5092] md:text-[14px] lg:!leading-[150%] xl:text-[20px]">
