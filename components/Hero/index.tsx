      ...
      >
        <div className="">
          ...
          <div className="mt-[21px] text-[10px] font-normal -tracking-[2%] text-[#959595] md:text-[14px] lg:!leading-[150%] xl:max-w-[1250px] xl:text-[16px] 2xl:text-[20px]">
            Discover and connect datasets lorem ipsum religaris tantumt vindum
            lorem lorem ipsum religaris tantumt vindum lorem lorem ipsum
            religaris tantumt vindum lorem lorem ipsum religaris tantumt vindum
            lorem lorem ipsum religaris tantumt vindum lorem
          </div>
