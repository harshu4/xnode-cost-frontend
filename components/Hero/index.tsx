...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white text-[#1E1E1E] lg:pt-[10px]"
      >
            ...
            <div className="w-full px-4">
              ...
              >
                <Image
                  ...
                  width={100}
                  height={20}
                  className="mx-auto h-[280px] w-[707px] scale-110 transition-all duration-200 hover:z-20 md:mt-1 lg:mt-20 lg:h-[402px]"
                />
