...
const Header = () => {
  ...
  return (
    <>
      <header className="top-0 left-0 z-40 mx-0 w-full items-center bg-[#fff] px-[17px] pt-[20px]  text-[#000000] md:px-[20px]  lg:px-[23px] lg:pt-[25px] xl:px-[26px] xl:pb-[27.8px] 2xl:px-[33px]  2xl:pb-[46px]">
        <div className="flex">
