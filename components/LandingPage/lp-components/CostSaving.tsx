const CostSaving = () => {
  ...
  return (
    <>
      <div className="mt-[100px] grid h-[94px] w-[512px] grid-cols-2 justify-around gap-[20px] md:flex md:w-[614px] md:flex-row md:gap-[120px] lg:w-[716px] lg:gap-[140px] xl:w-[820px] xl:gap-[160px] 2xl:w-[1024px] 2xl:gap-[200px]">
