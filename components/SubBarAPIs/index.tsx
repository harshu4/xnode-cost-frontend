          ...
          {categoriesOptions.map((option, index) => (
            <div key={index}>
              ...
              >
                ...
                <div className="mt-[9px] font-light text-[#000] md:mt-[11px] lg:mt-[12.5px] xl:mt-[14px] 2xl:mt-[18px]">
                  {option.desc}
                </div>
                <a href={option.linkRef} target="_blank" rel="noreferrer">
                  <div className="mt-[5.5px] max-w-[120px] text-[6px] font-light text-[#0354EC] hover:text-[#0243bd] md:mt-[6.6px] md:max-w-[144px] md:text-[7.2px] lg:mt-[6.7px] lg:max-w-[192px] lg:text-[8.4px] lg:!leading-[150%] xl:mt-[7.8px] xl:max-w-[220px] xl:text-[9.5px] 2xl:mt-[9px] 2xl:max-w-[275px] 2xl:text-[12px]">
                    {option.link}
                  </div>
                </a>
                <div
