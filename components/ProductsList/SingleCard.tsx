...
const SingleCard = ({
  ...
  return (
    <a href={`dataset/${id}`}>
      <div className="flex justify-start gap-x-[10px] rounded-[5px] border-[0.5px] border-[#D9D9D9] px-[7px] py-[15px] text-start text-[#000000] shadow-[0_5px_8px_0px_rgba(0,0,0,0.10)] md:max-w-[600px] lg:p-[21px] xl:gap-x-[20px]  xl:p-[24px] 2xl:max-w-[1000px] 2xl:gap-x-[25px] 2xl:p-[30px]">
